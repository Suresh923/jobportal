...
?>
<!-- Main Container -->
<div class="container-fluid" style="background:url('job.jpg');background-position: center; background-size: cover; background-repeat: repeat; background-attachment: fixed;">
